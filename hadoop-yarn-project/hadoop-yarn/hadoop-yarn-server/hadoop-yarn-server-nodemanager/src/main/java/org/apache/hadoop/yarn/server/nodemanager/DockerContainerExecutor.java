...
public class DockerContainerExecutor extends ContainerExecutor {
  ...
  public int launchContainer(Container container,
    ...
    //  }
      LOG.info("[[KAIROS INITIATE DOCKER shell command "+sb.getWrapperScriptPath().toString()+" containerIdStr "+containerIdStr +" userName "+userName+" pidFile "+pidFile);
      LOG.info("[[KAIROS COMMANDS in script " + commandStr);
      LOG.info("[[KAIROS containerWorkDir " + containerWorkDir);
