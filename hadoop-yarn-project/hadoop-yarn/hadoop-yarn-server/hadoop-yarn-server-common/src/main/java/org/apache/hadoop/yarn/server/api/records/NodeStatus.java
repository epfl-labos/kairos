...
public abstract class NodeStatus {
  ...
  public static NodeStatus newInstance(NodeId nodeId, int responseId,
      ...
      NodeHealthStatus nodeHealthStatus, long oldestYoungestAge) {
  ...
  public abstract long getOldestYoungestAge();
  ...
  public abstract void setOldestYoungestAge(long oldestYoungestAge);
}
